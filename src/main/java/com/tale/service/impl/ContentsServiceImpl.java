...
public class ContentsServiceImpl implements ContentsService {
    ...
    @Override
    public boolean spiderPost(String data, Users users) {
        try{
            ...
            String slug = contentJson.getString("slug");
            String tags = contentJson.getString("tags");
            String categories = contentJson.getString("categories");
            ...
            contents.setAllow_comment(true);
            contents.setAllow_ping(true);
            contents.setAllow_feed(true);
            ...
            LOGGER.error("save spider error ",e);
        }
        return false;
    }
